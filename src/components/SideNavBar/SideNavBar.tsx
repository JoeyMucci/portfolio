...
export const SideNavBar: FC<ToggleProps> = ({ toggle, switcher, curSect }) => {
  ...
  return (
    <nav
      ...
      style={{
        backgroundColor:
          colorScheme === 'light' ? themeL.colors!.pink![4] : themeL.colors!.orange![6],
      }}
    >
              ...
              {i === curSect ? (
                ...
                <UnstyledButton className={classes.element} onClick={() => switcher(i)}>
                  <nButt.Icon
                    ...
                    color={
                      colorScheme === 'light'
                        ? themeL.colors!.lightBlue![4]
                        : themeL.colors!.dark![7]
                    }
                  />
                </UnstyledButton>
              )}
      ...
      {colorScheme === 'light' ? (
        ...
        >
          ...
          >
            <IconMoonStars size={35} stroke={1.5} color={themeL.colors!.lightBlue![4]} />
          </UnstyledButton>
        </Tooltip>
      ) : (
        <Tooltip
        ...
        >
          <UnstyledButton
            ...
            className={classes.bottomElement}
          >
            <IconSun size={35} stroke={1.5} color={themeL.colors!.dark![7]} />
          </UnstyledButton>
        </Tooltip>
      )}
    </nav>
