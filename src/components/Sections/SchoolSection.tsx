...
import { Center, Paper, Stack, Text, Tooltip } from '@mantine/core';
    ...
    return (
      <>
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          ...
          {', '}
          <Link destination={labels.STUDIES} text="studied" />
          {', and '}
    ...
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          ...
          <Link destination={labels.CROSS} text="Cross Country/Track & Field" />
          {' and '}
  ...
  const Studies = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          I majored in <Link destination={labels.MATH} text="Applied Mathematics" />
          {' and '}
          <Link destination={labels.CS} text="Computer Science" />
          {' with a 4.0 GPA'}
        </Text>
      </>
    );
    ...
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          ...
          {', '}
          <Link destination={labels.VOLUNTEER} text="Volunteer" />
          {', and '}
  ...
  const Cross = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          As captain of NJIT's Cross Country team I served as a role model and kept the team on task
          during competition
        </Text>
      </>
    );
  ...
  const FinAct = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          As president, I organized club meetings and worked with the rest of the executive board on
  ...
  const Math = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          Some of the most engaging courses I've taken were differential equations, analysis, and
          linear algebra
        </Text>
      </>
    );
  ...
  const CS = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          I've enjoyed linux programming, data structures, and the capstone course, where I built a
          project with a team
        </Text>
      </>
    );
  ...
  const TA = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          As a three-time TA, I guided a cohort of first year students in a research project to
          improve NJIT's biodiversity
        </Text>
      </>
    );
  };
  ...
  const Volunteer = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          My most impactful and rewarding service opportunity has been teaching scratch coding at a
          local middle school
        </Text>
      </>
    );
  ...
  const OL = () => {
    return (
      <>
        ...
        <Text ta="center" mx="2" className={classes.unselectable} style={{ color: main }}>
          As an OL, I introduced NJIT to incoming students and learned how to deal with difficult
